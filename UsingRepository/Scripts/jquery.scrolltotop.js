...
$(document).ready(function() {
    ...
    var scrolltotop = {
        ...
        controlHTML:
            '<img src="/Content/themes/images/gotop.png" style="width:40px; height:40px; margin-top: 25px; margin-right: 17px;" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
